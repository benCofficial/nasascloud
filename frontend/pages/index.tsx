...
export default function Index({ code }) {
    ...
    const menu = (
        <Menu>
            ...
            <Menu.Item>
                <a target="blank" href="https://github.com/Nameless9000/">
                    Github Repo (Forked)
                </a>
            </Menu.Item>
        </Menu>
    ...
    return (
        <div className={styles.container}>
            <Head>
                <title>An astral paste dont judge.</title>
                <meta name="og:title" content="No."/>
                <meta name="og:description" content="Incorrect Format"/>
            ...
            <main className={styles.main}>
                ...
                <div style={{ marginTop: '8px' }}>
                    <Button
                        size="large"
                        icon={<LockOutlined />}
                        style={{ marginRight: '15px', borderRadius: '5px', height: '40px', borderColor: 'red' }}
                    ...
                    <Button
                        size="large"
                        icon={<UserOutlined style={{ marginRight: '8px', marginTop: '2px' }} />}
                        style={{ marginRight: '-5px', borderRadius: '5px', height: '40px', borderColor: 'red' }}
                    >
                    Credits
                        </Button>
                    </Dropdown>
